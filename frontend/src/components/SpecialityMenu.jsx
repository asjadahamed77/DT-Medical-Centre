...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
      <h1 className='text-3xl font-medium'>Filter by Specialty</h1>
      <p className='text-center text-sm '>Select the medical field to find specialists tailored to your needs.</p>
